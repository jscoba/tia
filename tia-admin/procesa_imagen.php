<?php
  ...
  $file_name = sprintf("%d-%s", $pti_id, $_FILES["pti_archivo"]["name"]);
  ...
  $file_path = sprintf("%s%d-%s", UPLOAD_PATH, $pti_id, $_FILES["pti_archivo"]["name"]);
	...
	//sleep(10);
  $yeah=move_uploaded_file($_FILES["pti_archivo"]["tmp_name"], $file_final_path);  
	//$yeah=move_uploaded_file($_FILES["pti_archivo"]["tmp_name"], "/devel-tia/tia-upload/");
  
?>

<a href="nueva_imagen.html">Otra imagen</a>
